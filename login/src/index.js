...
import Login from "./components/login/Login"
 ...
 import Stationery_updateview from './components/shopkeeper/Stationery_updateview';
...
root.render(
  <BrowserRouter>
    ...
    <Route path='/' element={<Main_login />}/>
      ...
      <Route path='/Stationery_updateview' element={<Stationery_updateview/>}/>
      <Route path='/Pharmacy_updateview' element={<Stationery_updateview/>}/>
